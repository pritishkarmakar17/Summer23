...
%\subsection{AM of Gaussian Beam}
...
\begin{table}[H]
	...
	\end{tabular} \\\hline
 	 ...
 	 A $(\ket{H})$ & $\boldsymbol{J}_A= \begin{bmatrix}1 \\ 0\end{bmatrix}$\\
 	
 	 R $(\ket{R})$ & $\boldsymbol{J}_R= \begin{bmatrix}1+i&1-i \\ 1-i & 1+i\end{bmatrix} \begin{bmatrix}1 \\ 0\end{bmatrix} = \begin{bmatrix}1+i\\1-i\end{bmatrix}=\begin{bmatrix}1\\-i\end{bmatrix} \exp(i\phi_1)$ \\
 	...
 	\parbox{5cm}{\begin{align*}
 			...
 			\end{bmatrix} 
 		\begin{bmatrix}1 \\ -i\end{bmatrix}\exp(i\phi_1)\\
 			&=\begin{bmatrix}\cos(\beta)\\\sin(\beta)\end{bmatrix} \exp(i\phi_1+i\phi_2)\:{\color{red}\exp(-i\beta)}
 	\end{align*}}\\
 	\hline
	\end{tabular}
