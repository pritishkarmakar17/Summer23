...
Main drawback of Jones formalism is that its application is restricted in fully polarized light. This formalism cannot explain the partially polarized or unpolished light which we frequently observe in practical use.{Stokes-Muller formalism}
...
\subsection{Introduction}
\subsection{Parallax wave equation and solutions}
From Maxwell's 3-D wave equation for electric field in vacuum,
\begin{align}
	\nabla^2\boldsymbol{E}(\boldsymbol{r},t) - \frac{1}{c^2}\frac{\partial^2}{\partial t^2}\boldsymbol{E}(\boldsymbol{r},t)=0
\end{align}
...
\begin{thebibliography}{99}
	\bibitem{milonni}
	Milonni, P.W. and Eberly, J.H. (2010) Laser Physics. Wiley \& Sons, Hoboken, Chapter 6. doi: 10.1002/9780470409718
	
	\bibitem{cornell}
	\href{https://www.youtube.com/playlist?list=PLyWzPf87clvEb8T3Xf30tMaUqdbVchrNY}{Lasers and Optoelectronics: ECE 4300 Cornell University} \href{https://www.youtube.com/watch?v=OLczG3zUULQ&list=PLyWzPf87clvEb8T3Xf30tMaUqdbVchrNY&index=8}{(Lecture 8)}
